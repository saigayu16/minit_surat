...
$id_dokumen = isset($_POST['id']) ? $_POST['id'] : 'tiada_id';
...
curl_setopt($ch, CURLOPT_POSTFIELDS, $data_pakej);
...
echo $respon; // Google akan hantar balik response JSON
?>