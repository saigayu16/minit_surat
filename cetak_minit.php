...
$catatan = $row['catatan'] ?? 'Tiada catatan tambahan diberikan.';
...
// Tandatangan - Pastikan ia dipanggil dengan cara yang betul
$signature_img = !empty($row['tandatangan']) ? $row['tandatangan'] : "";

// Gunakan papar_fail.php untuk mengelakkan ralat Forbidden
...
<div class="page-box">
    ...
    <div class="sticky-note">
        <div style="color: #2563eb; font-weight: bold; margin-bottom: 5px;">ARAHAN: <?= htmlspecialchars($arahan) ?></div>
