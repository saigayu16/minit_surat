...
<head>
    ...
    <style>
        ...
        .box { 
            background: #fff9c4; padding: 40px; border-radius: 2px 20px 2px 20px; 
            width: 100%; max-width: 400px; box-shadow: 15px 15px 30px rgba(0,0,0,0.15); 
            position: relative; transform: rotate(-2deg); transition: 0.3s;
        }
